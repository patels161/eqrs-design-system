...
export class AlertsComponent implements OnInit {
  ...
  successStatusContent = '<div class="eqrs-alert-success  col-md-12">\n' +
    ...
    '               </div>\n' +
    '             </div>';
  warningStatusContent = '<div class="eqrs-alert-warning  col-md-12">\n' +
    '               <div class="eqrs-alert-body">\n' +
  ...
  errorMultilineContent = '<div class="eqrs-alert-error  col-md-12">\n' +
    ...
    '               </div>\n' +
    '             </div>';
  errorSinglelineContent = '<div class="eqrs-alert-error  col-md-12">\n' +
    '               <div class="eqrs-alert-body">\n' +
    '                 <h4 class="eqrs-alert-heading">Error single line</h4>\n' +
    '                 <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod.</p>\n' +
    '                 <ul class="eqrs-single-list-item">\n' +
    ...
    '               </div>\n' +
    '             </div>';
  informationstStatusContent = '<div class="eqrs-alert-error  col-md-12">\n' +
    '               <div class="eqrs-alert-body">\n' +
